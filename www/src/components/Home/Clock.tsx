...
const Clock = props =>
    <svg {...props} stroke='none' fill='lightgrey' viewBox="0 0 226.6 233.8">
...
export class Component extends React.PureComponent<WithStyles<keyof ReturnType<typeof styles>>, State> {
    ...
    public render() {
        const divStyleHours = { transform: `rotateZ(${180 + this.state.date.getHours() * 30 + this.state.date.getMinutes() / 2}deg)` };
        const divStyleMinutes = { transform: `rotateZ(${180 + this.state.date.getMinutes() * 6 + this.state.date.getSeconds() / 10}deg)` };
        const divStyleSeconds = { transform: `rotateZ(${180 + this.state.date.getSeconds() * 6}deg)` };

        return (
            <div>
                <div className={this.props.classes.clockContainer}>
                    <Clock className={this.props.classes.clockBackground} />
                    <div className={this.props.classes.indicatorContainer} >
                        <div className={`${this.props.classes.indicator} ${this.props.classes.secondIndicator}`} style={divStyleSeconds} />
                        <div className={`${this.props.classes.indicator} ${this.props.classes.minuteIndicator}`} style={divStyleMinutes} />
                        <div className={`${this.props.classes.indicator} ${this.props.classes.hourIndicator}`} style={divStyleHours} />
                        <div className={this.props.classes.indicatorCover} />
                    </div>
